...
import { createPersonajeRoute } from './routes/personajes.js'

export const createApp = ({ PersonajeModel }) => {
    //Middlewares
    ...
    app.use('/personajes', createPersonajeRoute({ PersonajeModel }))//Se cargan todas las rutas de personajes
